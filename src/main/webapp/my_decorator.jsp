...
<!-- alert -->
    ...
    <link href="<c:url value="<%=request.getContextPath() %>/resources/css/jquery.modal.css"/>" type="text/css" rel="stylesheet" />
	<link href="<c:url value="<%=request.getContextPath() %>/resources/css/jquery.modal.theme-xenon.css"/>" type="text/css" rel="stylesheet" />
...
<script	src='<%=request.getContextPath() %>/resources/lib/fullcalendar.js'></script>
<script type="text/javascript"	src="<%=request.getContextPath() %>/resources/lib/gcal.js"></script>
...
<!-- Custom CSS -->
<link href="<%=request.getContextPath() %>/resources/css/3-col-portfolio.css"	rel="stylesheet">
<link rel="stylesheet"	href="<%=request.getContextPath() %>/resources/css/rb-switcher.min.css">
<link
